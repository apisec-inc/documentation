...
The expectation is that the user should already have an account with JIRA or know how to setup one.  You can find more information here.

<a href="https://confluence.atlassian.com/jirakb/how-to-find-your-site-url-to-set-up-the-jira-data-center-and-server-mobile-app-954244798.html">here</a>

1. From the homepage select your project > Select the Configurations tab 
...
10. Labels . Label should be a single word without any white spaces. If more than one label to be tagged, provide comma (,) seperated labels.
