...
In the Popup > Add the endpoint along with its method, for example: post:/api/v1/addAccount/sample > Save

<img width="1351" alt="Screen Shot 2022-09-30 at 22 48 37" src="https://user-images.githubusercontent.com/109250250/193392645-c1967cff-714f-4643-99ad-fef410b054bd.png">


You will be promoted to scan this specific endpoint against different categories.


Observe the newly endpoint and a tag is added to identify the manual entries.

<img width="1508" alt="Screen Shot 2022-09-30 at 22 49 17" src="https://user-images.githubusercontent.com/109250250/193392652-0b07bc09-f894-4505-8a92-da1a08559b93.png">
