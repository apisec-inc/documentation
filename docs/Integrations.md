...
**Note:**  1...When you're adding a new credential, from the drop down menu make sure to select the Account Type under the Report Storage section as shown in the screenshot.
